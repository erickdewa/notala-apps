...
List<OPPickVerifyModel> getAllCardListItems() {
  ...
  allCardList.add(OPPickVerifyModel(cardTitle: 'Visa', cardSubTitle: 'Erick Eeo', image: 'images/orapay/opchip.png', cardColor: opPrimaryColor, cardExpireDate: '12/20', cardNumber: '3456'));
  allCardList.add(OPPickVerifyModel(cardTitle: 'Visa', cardSubTitle: 'Erick Eeo', image: 'images/orapay/opchip.png', cardColor: opOrangeColor, cardExpireDate: '12/20', cardNumber: '3456'));
  allCardList.add(OPPickVerifyModel(cardTitle: 'Visa', cardSubTitle: 'Erick Eeo', image: 'images/orapay/opchip.png', cardColor: opPrimaryColor, cardExpireDate: '12/20', cardNumber: '3456'));
  allCardList.add(OPPickVerifyModel(cardTitle: 'Visa', cardSubTitle: 'Erick Eeo', image: 'images/orapay/opchip.png', cardColor: opOrangeColor, cardExpireDate: '12/20', cardNumber: '3456'));
  allCardList.add(OPPickVerifyModel(cardTitle: 'Visa', cardSubTitle: 'Erick Eeo', image: 'images/orapay/opchip.png', cardColor: opPrimaryColor, cardExpireDate: '12/20', cardNumber: '3456'));
...
List<OPPickVerifyModel> getTransactionListItems() {
  ...
  transactionList.add(OPPickVerifyModel(cardTitle: "Erick Eeo", cardSubTitle: "Payment Received", cardNumber: "+ ₹250", cardColor: Colors.red, icon: Icons.call_made));
  transactionList.add(OPPickVerifyModel(cardTitle: "Erick Eeo", cardSubTitle: "Payment Received", cardNumber: "+ ₹250", cardColor: Colors.red, icon: Icons.call_made));
  transactionList.add(OPPickVerifyModel(cardTitle: "Erick Eeo", cardSubTitle: "Payment sent", cardNumber: "- ₹50", cardColor: Colors.green, icon: Icons.call_received));
  transactionList.add(OPPickVerifyModel(cardTitle: "Erick Eeo", cardSubTitle: "Payment sent", cardNumber: "- ₹130", cardColor: Colors.green, icon: Icons.call_received));
  transactionList.add(OPPickVerifyModel(cardTitle: "Erick Eeo", cardSubTitle: "Payment Received", cardNumber: "+ ₹250", cardColor: Colors.red, icon: Icons.call_made));
